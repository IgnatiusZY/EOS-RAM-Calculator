...
The Chainbase === Boost Multi Index Table.
...
`Net Billable Ram Cost = (<no_of_struct_scopes> * config::billable_size_v<table_id_object>) + config::billable_size_v<key_value_object> + <contract_struct_row_size>`
